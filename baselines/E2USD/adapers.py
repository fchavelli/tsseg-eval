...
import sys
import os
from baselines.E2USD.utils import all_normalize
sys.path.append(os.path.dirname(__file__))
import baselines.E2USD.encoders
from baselines.E2USD.abstractions import *
...
class E2USD_Adaper(BasicEncoderClass):
    def _set_parmas(self, params):
        ...
        self.encoder = baselines.E2USD.encoders.DDEM(**self.hyperparameters)
