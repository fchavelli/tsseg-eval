...
import baselines.E2USD.utils as utils
import math
import torch
import baselines.E2USD.networks
...
class DDEM(BasicEncoder):
    def __init__(self, win_size, batch_size, nb_steps, lr,
        ...
        self.loss = baselines.E2USD.networks.fncc_loss.fncc_loss(
    ...
    def __create_network(self, in_channels, channels, depth, reduced_size,
        ...
        network = baselines.E2USD.networks.network.DDEM(
